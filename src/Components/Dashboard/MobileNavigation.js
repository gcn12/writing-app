...
const MobileNavigation = (props) => {
    return(
        <Modal aria-label='navigation menu' isOpen={props.showMobileNav} onDismiss={()=>props.setShowMobileNav(false)}>
            ...
            <NavContainer>
                <UL>
                    <MobileNavItem name='Files' type='projects' link='/writing-app/dashboard' setShowMobileNav={props.setShowMobileNav}>
                    ...
                    <MobileNavItem name='Tasks' type='goals' link='/writing-app/dashboard/goals' setShowMobileNav={props.setShowMobileNav}>
                    ...
                    <MobileNavItem name='Colors' type='themes' link='/writing-app/dashboard/themes' setShowMobileNav={props.setShowMobileNav}>
